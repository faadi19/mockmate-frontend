...
import { LogOut, Upload, FileText, X } from 'lucide-react';
...
const Sidebar = ({ onClose }: SidebarProps) => {
  ...
  return (
    <div className="w-[280px] lg:w-[20vw] lg:min-w-[200px] lg:max-w-[350px] bg-card border-r border-border h-screen flex flex-col p-4 lg:p-[1vw] shadow-2xl lg:shadow-none">
      ...
      {/* Logo and App Name */}
      <div className="flex items-center gap-2 mb-8 lg:mb-[3vw] px-3 lg:px-[1vw] pt-2 lg:pt-[1vw] cursor-pointer hover:opacity-90 transition-opacity" onClick={() => { navigate('/dashboard'); if (onClose) onClose(); }}>
        <img
          src={mmLogo}
          alt="MockMate Logo"
        ...
        />
        <span className="text-text-primary font-poppins-regular text-2xl lg:font-size-40px drop-shadow-[0_0_10px_rgb(var(--primary)/0.18)]"><strong>M</strong>ock<strong>M</strong>ate</span>
      </div>
      ...
      <div className="mt-auto flex flex-col gap-2 lg:gap-[0.3vw]">
        ...
        <button
          ...
          className="flex items-center gap-2 lg:gap-[0.7vw] px-2.5 lg:px-[1vw] py-2.5 lg:py-[0.5vw] text-red-500 hover:bg-red-500/10 transition-all duration-300 rounded-full group mt-2"
        >
          <LogOut size={20} className="lg:w-[1.5vw] lg:h-[1.5vw] group-hover:scale-110 transition-transform" />
